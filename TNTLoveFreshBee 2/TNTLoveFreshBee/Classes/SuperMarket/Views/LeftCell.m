...
+ (instancetype)cellWithTable:(UITableView *)tableView{
    LeftCell *cell = [tableView dequeueReusableCellWithIdentifier:flashCell];
    if (!cell) {
        cell = [[LeftCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:flashCell];
    }
    return cell;
}
